...
const FILES = [
  ...
  ['engine/src/flow.js', 'engine/src/flow.js'],
  ['engine/src/luck.js', 'engine/src/luck.js'],
  ['engine/src/pillar-relations.js', 'engine/src/pillar-relations.js'],
  ['engine/src/siling.js', 'engine/src/siling.js'],
